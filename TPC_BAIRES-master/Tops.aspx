<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tops.aspx.cs" Inherits="TPC_BAIRES.Tops" %>
...
<body>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <% if(cliente != null) { %>
             ...
             <li class="nav-item"> <a class="nav-link" href="/Registro">Registrarse</a> </li>
              <li class="nav-item"> <a class="nav-link" href="/Registro">Iniciar Sesión</a> </li>
             <% } %>
        </ul>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="card-columns" style="margin-left: 25px; margin-right: 25px;">
        ...
        <p></p>
        <p></p>        
        <% foreach (var item in productosfiltrados2)
            { %>
        <div class="card text-white bg-dark">
            ...
            <a href="/Shop.aspx?add=<%= item.Id %>" style="cursor: pointer"  >  Agregar al carrito</a>
        </div>
        <% } %>
    </div>
        <!-- /.row -->
